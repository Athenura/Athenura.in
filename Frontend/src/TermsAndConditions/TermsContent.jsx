    ...
    <div className="w-full" style={{ backgroundColor: theme.bg }}>
      <section className="py-10 md:py-16 px-4 md:px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Intro */}
          <div
            className="mb-10 md:mb-16 p-4 md:p-6 rounded-xl"
            style={{ backgroundColor: theme.bgAlt }}
          >
            <h2
              className="text-base md:text-xl font-semibold mb-3"
            ...
            <p className="text-sm md:text-base text-gray-700 leading-relaxed">
              ...
              Athenura’s website, programs, and services. Please read them
              carefully.
            </p>
          </div>
                        ...
                        <ol className="space-y-2 pl-0 md:pl-2">
                          {section.subsections.map((item, index) => (
                            <li key={index} className="flex items-start text-sm md:text-base">
                              <span className="w-5 h-5 rounded-full bg-teal-100 text-teal-600 text-[10px] md:text-xs flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                                {index + 1}
                              </span>
          ...
          <div className="mt-10 md:mt-16 p-4 md:p-6 rounded-xl border border-gray-200 text-center">
            <div
              className="inline-flex items-center gap-2 px-3 md:px-4 py-2 rounded-full max-w-full"
              style={{ backgroundColor: theme.primaryLight }}
            >
              <span className="text-base md:text-lg flex-shrink-0">📜</span>
              <span
                className="text-xs md:text-sm font-medium break-words text-left md:text-center"
                style={{ color: theme.primary }}
              >
