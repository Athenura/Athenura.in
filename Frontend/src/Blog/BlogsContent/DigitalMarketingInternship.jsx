...
const DigitalMarketingInternship = () => {
    ...
    const programUrl = typeof window !== 'undefined' ? window.location.href : `${siteUrl}/internship/digital-marketing-mastery`;
    const canonicalUrl = `${siteUrl}/internship/digital-marketing-mastery`;

    const programTitle = "Digital Marketing Mastery Internship at Athenura | Applications Open 2026";
    const programDescription = "Join Athenura's Digital Marketing Mastery Internship — a hands-on program where you learn SEO, paid ads, social media strategy, and analytics through real campaigns. Build your marketing portfolio with mentorship and land your dream marketing role.";

    const imageUrl = "https://ik.imagekit.io/vtfcbjo5c/digital.png";
    ...
    // EducationalOccupationalProgram Schema for Digital Marketing
    const programStructuredData = {
        ...
        "programPrerequisites": "Basic understanding of marketing concepts, curiosity about digital channels",
        "offers": {
            "@type": "Offer",
        ...
        "image": imageUrl,
        "keywords": "digital marketing internship, marketing internship, seo internship, paid ads internship, social media marketing internship, content marketing internship, digital marketing program, remote marketing internship",
        ...
        "hasCourse": [
            {
                ...
                "description": "Keyword research, on-page SEO, technical SEO, content optimization, and backlink building",
                "provider": { "@type": "Organization", "name": "Athenura" }
            },
            {
                "@type": "Course",
                "name": "Performance Marketing & Paid Ads",
                "description": "Google Ads, Meta Ads, audience targeting, budget allocation, and ROI optimization",
                "provider": { "@type": "Organization", "name": "Athenura" }
            },
            {
                "@type": "Course",
                "name": "Social Media Strategy",
                "description": "Brand positioning, content calendars, growth strategies, and engagement analytics",
                "provider": { "@type": "Organization", "name": "Athenura" }
            },
            {
                "@type": "Course",
                "name": "Content Marketing & Copywriting",
                "description": "Persuasive copywriting, funnel-based content planning, and landing page optimization",
                "provider": { "@type": "Organization", "name": "Athenura" }
            },
            {
                "@type": "Course",
                "name": "Marketing Analytics",
                "description": "Google Analytics, KPI dashboards, conversion tracking, and campaign performance reporting",
                "provider": { "@type": "Organization", "name": "Athenura" }
            }
        ],
        "jobOutcomeInfo": [
    ...
    const faqData = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "What is the duration of the Digital Marketing Mastery Internship?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "You need basic understanding of marketing concepts and curiosity about digital channels. No prior experience required — just willingness to learn and execute."
                }
            },
            {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "You'll learn SEO, performance marketing (paid ads), social media strategy, content marketing, copywriting, and marketing analytics through hands-on projects and real campaign execution."
                }
            },
            {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "You'll work on real projects including SEO blog strategy, paid ad campaigns, content calendars, and marketing performance reports with measurable results."
                }
            },
            {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes, we offer resume and portfolio optimization, mock marketing interviews, case-study presentation training, and referral pathways for top performers."
                }
            },
            {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes, the program is 100% remote with structured deadlines and weekly mentorship sessions."
                }
            },
            {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "You'll receive an Internship Certificate, performance-based Letter of Recommendation, Excellence Certificate for top performers, and a marketing portfolio with case studies."
                }
            },
            {
                "@type": "Question",
                "name": "Who is this internship NOT for?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "This internship is not for those looking for a passive certificate. It's for those ready to test ideas, analyze failures, optimize performance, and take ownership of results."
                }
            }
        ]
    };
    ...
    const courseData = {
        ...
        "coursePrerequisites": "Basic marketing concepts",
        "educationalCredentialAwarded": "Digital Marketing Internship Certificate",
        "timeRequired": "P3M",
        "offers": {
            "@type": "Offer",
            "category": "Free",
    ...
    return (
        ...
        <>
            ...
            <Helmet>
                ...
                <meta property="og:title" content="Digital Marketing Mastery Internship at Athenura | Learn by Doing" />
                <meta property="og:description" content={programDescription} />
                <meta property="og:image" content={imageUrl} />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="Athenura Digital Marketing Mastery Internship Program" />
                ...
                <meta name="twitter:title" content="Digital Marketing Mastery Internship - Applications Open" />
                <meta name="twitter:description" content={programDescription} />
                <meta name="twitter:image" content={imageUrl} />
                <meta name="twitter:image:alt" content="Digital Marketing Internship at Athenura" />

                {/* ---------- ADDITIONAL META ---------- */}
                <meta name="application-name" content="Athenura" />
                <meta name="apple-mobile-web-app-capable" content="yes" />
                <meta name="apple-mobile-web-app-status-bar-style" content="default" />
                <meta name="apple-mobile-web-app-title" content="Athenura Digital Marketing" />
